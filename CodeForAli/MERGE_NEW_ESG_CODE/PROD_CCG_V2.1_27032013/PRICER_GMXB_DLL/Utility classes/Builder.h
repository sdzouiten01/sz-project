...
//#include "Model point classes/Country model point classes/model_point_head_BL_01.h"

//#include "Projection classes/Country projection classes/Projection_BL_WDB_01.h"
//#include "Projection classes/Country projection classes/Projection_BL_WDBL_01.h"
#include "Projection classes/Country projection classes/head_BL.h"
#include "Model point classes/Country model point classes/model_point_head_BL_RST_SWISS_01.h"
#include "Model point classes/Country model point classes/model_point_head_BL_LUX_01.h"
#include "Model point classes/Country model point classes/model_point_head_BL_RST_CH_LIE_01.h"
#include "Model point classes/Country model point classes/model_point_head_BL_RS_CH_LIE_01.h"
#include "Model point classes/Country model point classes/model_point_head_BL_RST_DEIT_LIE_01.h"
#include "Model point classes/Country model point classes/model_point_head_BL_RS_DE_LIE_01.h"
							...
							const int t_high_shorter, bool l_longevity_tables, int t_step)
{
	...
	if(t_high_shorter > t_high){
		...
		sprintf_s(message, "Error: in Builder.h, parameter: t_high_shorter > t_high");
	...
	//}	
	//else if (!pCK.compare("CH_CHF_WB01")||!pCK.compare("ITA_EUR_WB01")||!pCK.compare("DEU_CHF_WB01")||
	//	!pCK.compare("DEU_EUR_WB01")||!pCK.compare("BEL_EUR_WB01"))
	//{	
	//	pro = new Projection_BL_LUX_GMWBD_01(i_s_a, f_s_a, assumption_file_name,generate_debug_files, debug_file_path, t_high_shorter, l_longevity_tables);
	//}
	//else if (!pCK.compare("DEU_EUR_WBL01")||!pCK.compare("AT_EUR_WBL01")||!pCK.compare("CH_EUR_WBL01")||
	//	!pCK.compare("CH_CHF_WBL01"))
	//{	
	//	pro = new Projection_BL_LUX_GMWBLD_01(i_s_a, f_s_a, assumption_file_name,generate_debug_files, debug_file_path, t_high_shorter, l_longevity_tables);
	//}
	else if (!pCK.compare("CH_WB01")){	
		pro = new Projection_BL_CH_GMWB_01(i_s_a, f_s_a, assumption_file_name,generate_debug_files, debug_file_path, t_high_shorter, l_longevity_tables);
	}
	else if (!pCK.compare("LIE_CH_WB01")){	
		pro = new Projection_BL_LIE_CH_GMWB_01(i_s_a, f_s_a, assumption_file_name,generate_debug_files, debug_file_path, t_high_shorter, l_longevity_tables);
	}
	else if ((!pCK.compare("LIE_DE_WB01"))||(!pCK.compare("LIE_IT_WBD01"))){	
		pro = new Projection_BL_LIE_DEIT_GMWB_01(i_s_a, f_s_a, assumption_file_name,generate_debug_files, debug_file_path, t_high_shorter, l_longevity_tables);
	}
	else if (!pCK.compare("LIE_DE_WBL01")){	
		pro = new Projection_BL_LIE_DE_GMWBL_01(i_s_a, f_s_a, assumption_file_name,generate_debug_files, debug_file_path, t_high_shorter, l_longevity_tables);
	}
	else if (!pCK.compare("LIE_CH_WBL01")){	
		pro = new Projection_BL_LIE_CH_GMWBL_01(i_s_a, f_s_a, assumption_file_name,generate_debug_files, debug_file_path, t_high_shorter, l_longevity_tables);
	}
	else if (!pCK.compare("LUX_WB01")){	
		pro = new Projection_BL_LUX_GMWBD_01(i_s_a, f_s_a, assumption_file_name,generate_debug_files, debug_file_path, t_high_shorter, l_longevity_tables);
	}
	else if (!pCK.compare("LUX_WBL01")){	
		pro = new Projection_BL_LUX_GMWBLD_01(i_s_a, f_s_a, assumption_file_name,generate_debug_files, debug_file_path, t_high_shorter, l_longevity_tables);
	}

	//else if ((!pCK.compare("DEU_IDB01") ||!pCK.compare("DEU_IAB01") ||
	//	!pCK.compare("DEU_IDB02") ||!pCK.compare("DEU_IAB02") || 
	//	!pCK.compare("DEU_IAB03")||!pCK.compare("DEU_IDB03")||
	//	!pCK.compare("DEU_IAB04")||!pCK.compare("DEU_IDB04")||
	//	!pCK.compare("DEU_IAB05")||!pCK.compare("DEU_IDB05"))&& t_step==ANNUAL)
	//{	
													...
													Scenario_configuration& scenario_config)
{
	...
	//else if(pCK == "CH_CHF_WB01" || pCK == "ITA_EUR_WB01"|| pCK == "DEU_CHF_WB01"||
	//pCK == "DEU_EUR_WB01"|| pCK == "BEL_EUR_WB01"|| pCK == "DEU_EUR_WBL01"|| pCK == "AT_EUR_WBL01"
	//|| pCK == "CH_EUR_WBL01"|| pCK == "CH_CHF_WBL01")
	//{
	//		pMP = new Model_Point_BL01(row, rank, product_config, scenario_config);
	//}
	else if(pCK == "CH_WB01"){
			pMP = new Model_Point_BL_RST_SWISS_01(row, rank, product_config, scenario_config);
	}
	else if(pCK == "LIE_CH_WB01"){
			pMP = new Model_Point_BL_RST_CH_LIE_01(row, rank, product_config, scenario_config);
	}
	else if(pCK == "LIE_DE_WB01"||pCK == "LIE_IT_WBD01"){
			pMP = new Model_Point_BL_RST_DEIT_LIE_01(row, rank, product_config, scenario_config);
	}
	else if(pCK == "LIE_DE_WBL01"){
			pMP = new Model_Point_BL_RS_DE_LIE_01(row, rank, product_config, scenario_config);
	}
	else if(pCK == "LIE_CH_WBL01"){
			pMP = new Model_Point_BL_RS_CH_LIE_01(row, rank, product_config, scenario_config);
	}
	else if(pCK == "LUX_WB01" || pCK == "LUX_WBL01"){
			pMP = new Model_Point_LUX_01(row, rank, product_config, scenario_config);
	}
	//else if ((!pCK.compare("DEU_IDB01") ||!pCK.compare("DEU_IAB01") ||
	//	!pCK.compare("DEU_IDB02") ||!pCK.compare("DEU_IAB02") || 
	//	!pCK.compare("DEU_IAB03")||!pCK.compare("DEU_IDB03")||
	//	!pCK.compare("DEU_IAB04")||!pCK.compare("DEU_IDB04")||
	//	!pCK.compare("DEU_IAB05")||!pCK.compare("DEU_IDB05")))
	//{
