#include "Projection_BL_LIE_CH_WBL_01.h"
//#define min(a, b) ( (a) < (b) ? (a) : (b) )
//#define max(a, b) ( (a) > (b) ? (a) : (b) )

Assumption_BL_LIE_CH_GMWBL_01::~Assumption_BL_LIE_CH_GMWBL_01(){	
		delete this->mortality_table;
		delete this->Longevity_mortality_table;
	}
Assumption_BL_LIE_CH_GMWBL_01::Assumption_BL_LIE_CH_GMWBL_01():Assumption0(){}
Assumption_BL_LIE_CH_GMWBL_01::Assumption_BL_LIE_CH_GMWBL_01(const char * tables):Assumption0(tables)
	{
		// Assumptions tables------------------------------------------------
...
double Assumption_BL_LIE_CH_GMWBL_01::Get_mortality_rates_vector(const string& sex,const int& current_year,const int& valn_age,const int& valn_year)
	{
		this->index1_l_local=((sex == "MALE")||(sex == "M"))*(current_year-2007)+((sex != "MALE")&&(sex != "M"))*(current_year-2007+88);
...
double Assumption_BL_LIE_CH_GMWBL_01::Get_longevity_mortality_rates_vector(const string& sex,const int& current_year,const int& valn_age,const int& valn_year)
	{
		this->index1_l_local=((sex == "MALE")||(sex == "M"))*(current_year-2007)+((sex != "MALE")&&(sex != "M"))*(current_year-2007+88);
		this->index_2_local=valn_age-29-valn_year+2008;
...
Projection_BL_LIE_CH_GMWBL_01::~Projection_BL_LIE_CH_GMWBL_01(){	delete this->Assumption;}
Projection_BL_LIE_CH_GMWBL_01::Projection_BL_LIE_CH_GMWBL_01( const vector<vector <int>>& i_s_a,const char * tables, bool generate_dbg_files,const string& debug_file_path)
	...
	///////////////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////
void Projection_BL_LIE_CH_GMWBL_01::set_Local_Parameters_to_zero()
	{
		set_Local_Parameters_to_zero0();
		basis_capital_1=0.;
		account_value_2=0.;	
	}
void Projection_BL_LIE_CH_GMWBL_01:: mySet_Debug_File_Header(){
...
void Projection_BL_LIE_CH_GMWBL_01::set_current_model_point(Model_Point *mp)
	{
...
void Projection_BL_LIE_CH_GMWBL_01::init_Count_scen_to_zero(){this->ModelPoint->Calc_Count_Scen=0;}
		int Projection_BL_LIE_CH_GMWBL_01::Count_scen(){return this->ModelPoint->Calc_Count_Scen;}
void Projection_BL_LIE_CH_GMWBL_01::Increase_Count_scen(){this->ModelPoint->Calc_Count_Scen +=1;}
	///////////////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////
void Projection_BL_LIE_CH_GMWBL_01::initialise_mp_calculation()
	{
...
void Projection_BL_LIE_CH_GMWBL_01::Calculate_ConstVector_timing()
	{
...
void Projection_BL_LIE_CH_GMWBL_01::Calculate_ConstVector_guarantees()
	{
...
void Projection_BL_LIE_CH_GMWBL_01::Calculate_ConstVector_decrement()
	{
	...
	//////////////////////////////////////////////////////////////////////////////////
void Projection_BL_LIE_CH_GMWBL_01::projection_base_contract(int curr_shock_number)
	{
		...
		for( int t=0; t <= this->ModelPoint->Calc_Remaining_Months ; t++)
		{
			if(t==0){
				...
				account_value=this->ModelPoint->Av_After_After*(this->ShockArray[curr_shock_number][1]*0.01+1.);		//BG: AV_lux replaced with Av_After_After_Bl. Right?
				survival_index=1.;
			...
			else
			{
				/*if(t < this->ModelPoint->Calc_Remaining_Months)
					pvs[curr_shock_number][PV_AV_NEW_RE_BL]+=account_value*MainProjArrayVector[DISCOUNT_FACTOR][t-1];*/
				...
				if((int)ConstVector[IND_RATCHET_MONTH_LIE][t]==1)
					basis_capital=max(account_value,(annuity_per_freq+add_coupon_from_ratchet)/(this->ModelPoint->Withdrawal_Rate/this->ModelPoint->Calc_Freq_Pay/(1.+this->ModelPoint->Withrawals_Mode_Discount_Bl)));
...
void Projection_BL_LIE_CH_GMWBL_01::PresentValueCalculation(int curr_shock_number,bool delta)
	{
		...
		// Calculate rates
		this->ModelPoint->index_shock_pvs[curr_shock_number][PV_RRC_RATE_TOT]=this->ModelPoint->Ong_Charge_1_Bl ;					
		this->ModelPoint->index_shock_pvs[curr_shock_number][PV_GUARANTEE_FEES_RATE]=this->ModelPoint->Calc_Gaur_Charge_Rate;		
		this->ModelPoint->index_shock_pvs[curr_shock_number][PV_FIXED_FEES_RATE]=this->ModelPoint->Ong_Charge_2_Bl;
		...
		this->ModelPoint->index_shock_pvs[curr_shock_number][PV_GUARANTEE_FEES_CHARGES]=this->ModelPoint->index_shock_pvs[curr_shock_number][PV_RRC_TOT_CHARGES]/this->ModelPoint->Ong_Charge_1_Bl*this->ModelPoint->Calc_Gaur_Charge_Rate;
