#pragma once
#ifndef DELTA_FUTURES_IN_PORTFOLIO_2_H
#define DELTA_FUTURES_IN_PORTFOLIO_2_H
#include "Nbr_Futures.h"
#include "Delta_Futures.h"
#include "Assumptions.h"
/**
* Class for Deltas due to futures in porfolio <BR>
* <CODE>tab[i][j]=delta_futures[i][j]*nbr_futurestab[i][j]+ tab[i][j-1]</CODE>
*/
...
public:
	...
	Delta_Futures_In_Portfolio_2(Assumptions* assumptions,Delta_Futures* delta_futures);
	~Delta_Futures_In_Portfolio_2(void);
};
#endif