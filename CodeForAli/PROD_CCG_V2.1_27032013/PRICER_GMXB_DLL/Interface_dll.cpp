...
*/
_declspec (dllexport) int ALI_BL_esg_projection(string& config_Projection, ofstream& log_strm, int nb_of_workers, int worker_id, string& s);
...
int ALI_BL_esg_projection(string& config_projection, ofstream& log_strm, int nb_of_workers, int worker_id, string& s)
{
 	...
 	try 
		{
			...
			load_run_configuration_esg(config_projection_bis,
				product_configurations,
				trace_log_pth,
				false);
