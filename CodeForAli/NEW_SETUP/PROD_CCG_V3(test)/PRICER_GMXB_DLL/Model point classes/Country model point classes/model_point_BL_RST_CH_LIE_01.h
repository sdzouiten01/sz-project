...
public:
	...
	Model_Point_BL_RST_CH_LIE_01(vector<string>& row, int rank, Scenario_configuration& scenario_config);
	Model_Point_BL_RST_CH_LIE_01(vector<string>& row, int rank,Scenario_configuration& scenario_config, int pv_nb);
	Model_Point_BL_RST_CH_LIE_01(Model_Point * mp);
