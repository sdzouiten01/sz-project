...
void Projection_BL_CH_GMWB_01::initialise_mp_calculation()
{
	...
	this->ModelPoint->Calc_Duration_Months=(this->ModelPoint->Calc_Valn_Year-this->ModelPoint->Calc_IssueDate_Year)*12
		+(this->ModelPoint->Calc_Valn_Month-this->ModelPoint->Calc_IssueDate_Month);
	this->ModelPoint->Calc_Remaining_Months=this->ModelPoint->Duration_Bl-this->ModelPoint->Calc_Duration_Months;
	this->ModelPoint->Calc_Deferal_Duration_Months=-(this->ModelPoint->Calc_Valn_Year-this->ModelPoint->Calc_Annuity_Begin_Year)*12
		-(this->ModelPoint->Calc_Valn_Month-this->ModelPoint->Calc_Annuity_Begin_Month);
	this->ModelPoint->Calc_Prorata=( 31. - min(this->ModelPoint->Calc_Valn_Day,30) )/30.;
	this->ModelPoint->Calc_Fund_Fees_p_m=this->ModelPoint->Fund_Fees/12.;		this->ModelPoint->Calc_Ehc_p_m=this->ModelPoint->Ehc/12.;
